...
./test --test=taxi --engines=manticoresearch:columnar_plain --memory=110000 --dir=results/taxi/manticoresearch
...
./test --test=hn_small --engines=manticoresearch:plain --memory=110000 --dir=results/hn_small/manticoresearch
...
./test --test=hn --engines=manticoresearch:columnar_plain --memory=110000 --dir=results/hn/manticoresearch
./test --test=hn --engines=manticoresearch:plain --memory=110000 --dir=results/hn/manticoresearch
...
./test --test=logs10m --engines=manticoresearch:columnar_plain --memory=110000 --dir=results/logs10m/manticoresearch --query_timeout=600
./test --test=logs10m --engines=manticoresearch:plain --memory=110000 --dir=results/logs10m/manticoresearch --query_timeout=600
